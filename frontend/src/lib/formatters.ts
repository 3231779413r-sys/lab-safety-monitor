...
const LEGACY_SAFETY_LABELS: Record<string, string> = {
  ...
  no_head_mask: "未戴头套",
  head_mask: "头套",
  no_protective_clothing: CANONICAL_SAFETY_LABELS.protective_clothing,
  no_safety_vest: CANONICAL_SAFETY_LABELS.protective_clothing,
  no_safety_est: CANONICAL_SAFETY_LABELS.protective_clothing,
  vest: CANONICAL_SAFETY_LABELS.protective_clothing,
  no_vest: CANONICAL_SAFETY_LABELS.protective_clothing,
  ...
  no_work_clothes: CANONICAL_SAFETY_LABELS.protective_clothing,
